namespace Loupedeck.LogiForUnityPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LogiForUnityPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LogiForUnityPlugin.Resources.Resource.txt`.
